...
export default function HomeLayout() {
    ...
    return <main className="home-reference">
        ...
        <section className="giant-text-section home-reference-wordmark" aria-label="BMSCE Rocketry"><div><h2 className="giant-text">BMSCE ROCKETRY</h2><h2 className="giant-text" aria-hidden="true">BMSCE ROCKETRY</h2></div></section>
        <AboutUs />
